...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    tagline: 'Family care for up to 3 members',
    price: 499,
    period: 'month',
    priceDisplay: '499',
    popular: true,
    ...
    features: [
      ...
      { text: 'Family member profiles (up to 3 members)', included: true },
      { text: 'AI-powered health insights', included: true },
      { text: 'Health records vault', included: true },
      { text: 'Medicine reminders', included: true },
      { text: 'Priority doctor access', included: false },
  ...
  },
  {
    id: 'premium-yearly',
    name: 'Premium Yearly',
    tagline: 'Full coverage for up to 6 members',
    price: 4999,
    period: 'year',
    priceDisplay: '4,999',
    popular: false,
    ...
    features: [
      ...
      { text: '2 months free vs monthly billing', included: true },
      { text: 'Family member profiles (up to 6 members)', included: true },
      { text: 'Annual health checkup voucher', included: false },
      { text: 'Free medicine delivery', included: false },
      { text: 'Exclusive health tips', included: false },
