...
export default function CanvasBackground() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // ── Neural connections (connect nearby stars)
      ...
      // ── Glowing rings (3D perspective ellipses)
      const cx = W / 2, cy = H / 2;
      ...
      for (const orb of orbs) {
        ...
        if (orb.trailPoints.length > 30) orb.trailPoints.shift();
