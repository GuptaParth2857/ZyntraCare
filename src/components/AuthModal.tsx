...
export default function AuthModal({ isOpen, onClose, onLogin }: AuthModalProps) {
  ...
  const handleSaveProfile = async () => {
    setLoading(true);
    const profile = { name, phone, city, age, bloodGroup, conditions, createdAt: new Date().toISOString() };
    localStorage.setItem('healthhub_user_profile', JSON.stringify(profile));
    try {
