...
import { FiArrowLeft, FiClock, FiSearch, FiArrowRight, FiHeart, FiTrendingUp, FiZap } from 'react-icons/fi';
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden font-inter">
      <div className="relative z-10 pt-24 pb-16">
        ...
        >
          <TiltCard>
            <div className="relative bg-gradient-to-br from-emerald-900/40 via-slate-900/80 to-teal-900/40 backdrop-blur-xl border border-emerald-500/20 rounded-[2.5rem] p-8 md:p-12 overflow-hidden group hover:border-emerald-500/30 transition-all duration-500 shadow-[0_0_60px_rgba(16,185,129,0.1)]">
              {/* 3D Depth Layers */}
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center" style={{ transformStyle: 'preserve-3d' }}>
                <motion.div
                  style={{ transformStyle: 'preserve-3d' }}
                  animate={{ z: [0, 10, 0] }}
                  transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
                >
                  <div className="flex items-center gap-3 mb-6">
                    <motion.span
                      ...
                      className="px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider bg-red-500/20 text-red-400 border border-red-500/30"
                    >
                      Must Read
                    </motion.span>
                ...
                <motion.div
                  ...
                  style={{ transformStyle: 'preserve-3d' }}
                  animate={{ z: [0, -10, 0], rotateY: [0, 2, 0] }}
        ...
        <div className="max-w-7xl mx-auto px-4">
          {loading ? (
            <div className="flex items-center justify-center py-20">
              <motion.div
                className="w-12 h-12 border-4 border-emerald-500/30 border-t-emerald-400 rounded-full"
                animate={{ rotate: 360 }}
            ...
            <div className="text-center py-20">
              <FiHeart className="mx-auto text-4xl text-gray-600 mb-4" />
              <p className="text-gray-400 font-bold text-lg">No articles yet</p>
              <p className="text-gray-600 text-sm">Check back soon for new health articles</p>
            </div>
          ) : (
          ...
          {/* Newsletter Section - 3D Parallax */}
          <motion.div
          ...
          >
            ...
            <motion.div
              className="relative bg-gradient-to-br from-emerald-900/30 to-teal-900/30 backdrop-blur-xl border border-emerald-500/20 rounded-[2rem] p-10 md:p-16 text-center"
              style={{ transformStyle: 'preserve-3d' }}
              animate={{ z: [0, 15, 0] }}
              transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
            >
              <motion.div
                animate={{ scale: [1, 1.05, 1], rotateY: [0, 360, 0] }}
